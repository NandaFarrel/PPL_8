...
import styles from "./t-a-b-u-s-e-r-s-m-a-h-a-s-i-s-w-a.module.css";

const TABUSERSMAHASISWA = () => {
  ...
  return (
    <div className={styles.tabUsersMahasiswa}>
      ...
      <div className={styles.tabUsersMahasiswaChild} />
      ...
      <div className={styles.tabUsersMahasiswaItem} />
      ...
      <div className={styles.tabUsersMahasiswaInner} />
