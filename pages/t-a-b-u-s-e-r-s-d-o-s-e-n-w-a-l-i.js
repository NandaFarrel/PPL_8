...
import styles from "./t-a-b-u-s-e-r-s-d-o-s-e-n-w-a-l-i.module.css";

const TABUSERSDOSENWALI = () => {
  const router = useRouter();

  const onButtonContainerClick = useCallback(() => {
    router.push("/t-a-b-u-s-e-r-s-o-p-e-r-a-t-o-r");
  }, [router]);
  ...
  return (
    <div className={styles.tabUsersDosenWali}>
      ...
      <div className={styles.tabUsersDosenWaliChild} />
      ...
      <div className={styles.tabUsersDosenWaliItem} />
      ...
      <div className={styles.tabUsersDosenWaliInner} />
      ...
      <div className={styles.dosenWali}>Dosen Wali</div>
